...
public class PlatRepositoryMariadb implements PlatRepositoryInterface, Closeable {
    ...
    public Plat getPlat(int id) {
        ...
        try (PreparedStatement ps = dbConnection.prepareStatement(query)) {
            ...
            if (result.next()) {
                ...
                selectedPlat = new Plat(nom, description, prix, createurNom, dateCreation);
    ...
    public List<Plat> getAllPlats() {
        ...
        try (PreparedStatement ps = dbConnection.prepareStatement(query)) {
            ...
            while (result.next()) {
                ...
                Plat plat = new Plat(nom, description, prix, createurNom, dateCreation);
                plat.setId(id);
                plats.add(plat);
            }
        } catch (SQLException e) {
    ...
    public Plat addPlat(Plat plat) {
        String query = "INSERT INTO Plat (nom, description, prix, createur_nom, date_creation) VALUES (?, ?, ?, ?, ?)";
        int id = 0;
        ...
        try (PreparedStatement ps = dbConnection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setDate(5, new java.sql.Date(plat.getDateCreation().getTime()));
